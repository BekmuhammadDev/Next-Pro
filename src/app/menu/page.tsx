...
import Card from "../../components/ui/menuCars"
    ...
    return (
      ...
      <section>
        ...
        <div className='mt-40 flex justify-between'>
          ...
          <div className='w-[1648px] h-[769px] absolute z-30 left-40   rounded-[70px] shadow-lg bg-[#90E051] p-10  '>
            <input type="text" placeholder='Search' className='absolute w-[253px] h-[45px] rounded-[20px] p-5'/>
            <div className='grid grid-cols-6 grid-rows-2 gap-20 mt-24 mr-10 '>
              <Card />
              <Card />
              <Card />
              <Card />
